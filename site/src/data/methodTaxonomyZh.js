const methodTaxonomyZh = {
  ...
  coevolution: {
    label: "共同演化",
    summary: "哪些会发生变化的角色或组件相互影响。",
    note: "系统中存在两个角色并不等于共同演化，双方都必须发生更新。",
    items: {
      None: ["无", "只有一个主要角色或产物发生变化。"],
      "Agent↔Agent": ["智能体↔智能体", "多个智能体通过彼此提供的证据或材料共同变化。"],
      "Agent↔Evaluator": ["智能体↔评价器", "执行任务的智能体与评价器都发生变化。"],
      "Agent↔Updater": ["智能体↔更新器", "任务智能体与负责改进它的机制都发生变化。"],
      "Experience↔Capability": ["经验↔能力", "经验指导新能力生成，新能力又产生新的经验。"],
      "Skill↔Tool": ["技能↔工具", "技能与可调用工具相互诊断、约束或修改。"],
    },
  },
  selection: {
    label: "保留标准",
